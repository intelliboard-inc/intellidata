...
Installation
-----------
1. Download the latest release zip from https://github.com/intelliboard-inc/intellidata/releases/latest
2. Install the plugin as local plugin (the release zip unpacks to `local/intellidata`, no renaming required)
